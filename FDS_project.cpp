...
/*Here in this project we are trying to display the use of doubly linked list in Cpp, by using a president, secretary, and a few members as an example. I have used President as the head node, Secretary as the tail node and the Members as all the nodes in between

We have also concatenated the nodes defined inside the function
